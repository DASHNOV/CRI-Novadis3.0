...
namespace NovadisApi.Data.Migrations
{
    ...
    [Migration("20260427100000_AddTrustedDeviceToken")]
    partial class AddTrustedDeviceToken
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("NovadisApi.Models.UserToken", b =>
                {
                    ...
                    b.HasIndex("TrustedDeviceToken")
                        .IsUnique()
                        .HasFilter("[TrustedDeviceToken] IS NOT NULL");
